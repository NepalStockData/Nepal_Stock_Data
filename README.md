...
│
├── 📂 .github/workflows/                   # Automation Scripts (5 Workflows)
...
│   └── Cleanup_Old_Workflow_Runs.yml       # Weekly/monthly workflow run cleanup (00:00 UTC)
│
...
| 🗑️ Cleanup      | Weekly + Monthly | 00:00      | 6:00 AM  | Deletes workflow runs older than 30 days |
...
| **Cleanup Old Workflow Runs** | Weekly Sunday + 15th (00:00 UTC) | Deletes workflow runs older than 30 days |
